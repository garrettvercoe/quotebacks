      ...
      chrome.storage.local.get([page], function(result) {
        ...
        p.querySelector("#getlink").addEventListener("click", function(event) {
          ...
          <div id="quoteback-parent" class="quoteback-parent">
              <div class="quoteback-content">
				 ${text}
					</div>       
          </div>

          <div class="quoteback-head">       
              <div class="quoteback-avatar"><img class="mini-favicon" src="${page_object["favicon"]}"></div>     
              <div class="quoteback-metadata">
                  <div class="metadata-inner">
                      <div  id="quoteback-author" class="quoteback-author">${page_object["author"]}</div>
                      <div class="quoteback-title">${encodeURIComponent(page_object["title"])}</div>
                  </div>  
              </div>

          <div class="quoteback-backlink"><a target="_blank" aria-label="go to the full text of this quotation" rel="noopener" href="${page_object["url"]}" class="quoteback-arrow">Go to text <span class="right-arrow">→</span></a></div>
          </div>  
      </div>`
