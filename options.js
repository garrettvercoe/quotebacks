...
document.addEventListener("DOMContentLoaded", function(){
  chrome.storage.local.get(null, function(items) {
    ...
    $('#rightpanel').on('click',"#embedLink", function() {
      ...
      var favicon = quote.attr("favicon");
          ...
          <div class="quoteback-head">       
              ...
              <div class="quoteback-metadata">
                  <div class="metadata-inner">
                      <div  id="quoteback-author" class="quoteback-author">${author}</div>
                      <div class="quoteback-title">${encodeURIComponent(title)}</div>
                  </div>  
              </div>

          <div class="quoteback-backlink"><a target="_blank" aria-label="go to the full text of this quotation" rel="noopener" href="${url}" class="quoteback-arrow">Go to text <span class="right-arrow">→</span></a></div>
          </div>  
      </div>
`
